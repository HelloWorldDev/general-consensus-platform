...
class AlgorandNode extends Node {
    ...
    reportToSystem() {
        const softVotesS = (this.softVotes[this.p]) ? 
            '' + this.softVotes[this.p].length : '0';
        const certVotesS = (this.certVotes[this.p]) ? 
            '' + this.certVotes[this.p].length : '0';
        const nextVotesS = (this.nextVotes[this.p]) ? 
            '' + this.nextVotes[this.p].length : '0';
        ...
        const info = {
            v: { s: this.v, w: 15 },
            round: { s: '' + this.p, w: 15 },
            step: { s: '' + this.step, w: 15 },
            softVotes: { s: softVotesS, w: 15 },
            certVotes: { s: certVotesS, w: 15 },
            nextVotes: { s: nextVotesS, w: 15 },
